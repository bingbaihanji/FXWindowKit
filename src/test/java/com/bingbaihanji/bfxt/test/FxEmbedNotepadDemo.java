...
//    private HWND getFxHwnd() {
//        long hwnd = com.sun.glass.ui.Window.getWindows().getFirst().getNativeWindow();
...
//
//    // 4️⃣ 嵌入逻辑
//    private void embed(HWND child, Scene scene) {
